			...
			if (studentMajor == 1) {
				try {
					...
					while (fileScan.hasNextLine()) {
						...
						ENGRstudent student = new ENGRstudent(name + " " + LName, age);
			...
			if (studentMajor == 2) {
				try {
					...
					while (fileScan.hasNextLine()) {
						...
						LName = fileScan.next();
						age = fileScan.nextInt();
						SCIstudent student = new SCIstudent(name + " " + LName, age);
			...
			if (studentMajor == 3) {
				try {
					...
					while (fileScan.hasNextLine()) {
						...
						LName = fileScan.next();
						age = fileScan.nextInt();
						BIOstudent student = new BIOstudent(name + " " + LName, age);
			...
			if (studentMajor == 4) {
				try {
					...
					while (fileScan.hasNextLine()) {
						...
						LName = fileScan.next();
						age = fileScan.nextInt();
						Professor student = new Professor(name + " " + LName, age);
